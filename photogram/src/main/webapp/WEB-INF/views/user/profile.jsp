	...
	<div class="profileContainer">
		...
		<div class="profile-left">
			<div class="profile-img-wrap story-border"
				...
				<img class="profile-image" src="/upload/${dto.user.profileImageUrlString}"
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<c:forEach var= "image" items = "${dto.user.images }"><!--EL표현식에서 get함수가 자동 호출됨  -->
					<div class="img-box">
						<a href=""> <img src="/upload/${image.postimageUri}" />
						</a>
						<div class="comment">
